...
public class SokobanGame implements Observer {
	...
	public static final int NumeroTotalDeNiveis = 3;
	...
	private void nextLevel() { // Passa para o proximo level, se ja nao existe mais niveis, entao o jogo foi ganho e volta para o primeiro mapa;
		...
		saveScore(Player.getPlayer().getMovimentos(), level);
	 ...
	 */
	public static AbstractObject objectInPosition(AbstractObject proprioObj, Position position) { // Verifica qual o objecto em certa posiçao;
	...
	public void gameOver() { // Reinicia o mapa
		ImageMatrixGUI.getInstance().update();
		Resultado.guiMensage("Better Luck next time.", "Game Over!");
